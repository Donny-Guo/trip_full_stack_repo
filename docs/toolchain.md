...
- Downstream enforcement: **F-01/ISSUE-003 completed locally on 2026-08-02; F-02/ISSUE-004 completed locally and reverified on Next.js 16 on 2026-08-03**

“Frozen” means downstream tasks must use these exact direct selections unless a reviewed same-change update modifies this matrix. D-25 supersedes only the original Next.js/MUI/TypeORM selections; the rest of P-03 remains in force. The P-03 status did not by itself assert installation, lockfile, build, native-runtime, database, or CI results; those claims belong to the downstream enforcement tasks named below. F-01 supplies the root installation, lockfile, and task-graph evidence. F-02 supplies the installed Next.js Web evidence. MUI SSR, TypeORM/PostgreSQL runtime behavior, native-module loading, database-image verification, and CI remain assigned to their later owners.
...
| MUI | `@mui/material@9.2.0`, `@mui/icons-material@9.2.0`, `@mui/material-nextjs@9.1.1` | MUI v9 is the supported stable major. Material/Icons accept React `^19`; the independently versioned integration accepts Next `^16`, React `^19`, and exposes `v16-appRouter`. No MUI package is installed until W-01 owns the integration. | W-01 manifest, `AppRouterCacheProvider`, theme and SSR proof | R2 | [Material 9.2.0](https://www.npmjs.com/package/@mui/material/v/9.2.0), [icons 9.2.0](https://www.npmjs.com/package/@mui/icons-material/v/9.2.0), [Next integration 9.1.1](https://www.npmjs.com/package/@mui/material-nextjs/v/9.1.1), [MUI support](https://mui.com/material-ui/getting-started/support/), [App Router guide](https://mui.com/material-ui/integrations/nextjs/) |
| Emotion | `@emotion/react@11.14.0`, `@emotion/styled@11.14.1`, `@emotion/cache@11.14.0` | Satisfies MUI v9 and `@mui/material-nextjs` peer ranges. Optional `@emotion/server` is not selected for the App Router path. | W-01 Web manifest and SSR cache provider | R2 | [Emotion React](https://www.npmjs.com/package/@emotion/react/v/11.14.0), [Emotion styled](https://www.npmjs.com/package/@emotion/styled/v/11.14.1), [Emotion cache](https://www.npmjs.com/package/@emotion/cache/v/11.14.0) |
...
| MUI 9.2.0 + `@mui/material-nextjs` 9.1.1 `v16-appRouter` cache provider and hydration/style ordering | W-01 / ISSUE-008 | Server render, hydration, navigation and production build evidence |
...
P-03 therefore closed as a version-policy task on 2026-08-02 after the English/Chinese documents passed repository documentation checks. D-25 amended its Web/ORM rows on 2026-08-03; Next.js 16.2.12 then passed install, lint, route type generation, strict TypeScript, and production build in F-02. MUI and TypeORM runtime evidence remains explicitly pending under W-01 and B-01. Downstream failures reopen the relevant compatibility decision through a reviewed matrix update; they are never hidden with `--force`, legacy peer handling, unpinned replacements, or skipped tests.
