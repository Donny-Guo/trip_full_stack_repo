...
| Component | Exact selection | Compatibility and support evidence | Pin / downstream enforcement | Class | Primary source |
| --- | --- | --- | --- | --- | --- |
| ESLint | `eslint@9.39.5`, `@eslint/js@9.39.5`, `typescript-eslint@8.65.0`, `eslint-config-prettier@10.1.8`, `globals@17.9.0` | Next 16 publishes native flat configs and accepts ESLint `>=9`; F-02 imports `core-web-vitals` and `typescript` directly and no longer carries `@eslint/eslintrc`/`FlatCompat` as a direct compatibility dependency. `typescript-eslint` accepts TypeScript 5.9.3 and ESLint 9. ESLint 10 remains excluded until the shared F-04 stack proves a compatible intersection. | F-02 app-local native flat config; F-04 shared flat config; F-07 staged lint; F-06 lint | R3 | [ESLint](https://www.npmjs.com/package/eslint/v/9.39.5), [ESLint JS](https://www.npmjs.com/package/@eslint/js/v/9.39.5), [Next ESLint guide](https://nextjs.org/docs/app/api-reference/config/eslint), [typescript-eslint](https://www.npmjs.com/package/typescript-eslint/v/8.65.0), [config-prettier](https://www.npmjs.com/package/eslint-config-prettier/v/10.1.8), [globals](https://www.npmjs.com/package/globals/v/17.9.0) |
...
P-03 therefore closed as a version-policy task on 2026-08-02 after the English/Chinese documents passed repository documentation checks. D-25 amended its Web/ORM rows on 2026-08-03; Next.js 16.2.12 then passed install, lint, route type generation, strict TypeScript, and production build in F-02. W-01 completed MUI runtime/SSR evidence on 2026-08-05; TypeORM runtime evidence remains explicitly pending under B-01. Downstream failures reopen the relevant compatibility decision through a reviewed matrix update; they are never hidden with `--force`, legacy peer handling, unpinned replacements, or skipped tests.
