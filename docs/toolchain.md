...
| Component | Exact selection | Compatibility and support evidence | Pin / downstream enforcement | Class | Primary source |
| --- | --- | --- | --- | --- | --- |
| ESLint | `eslint@9.39.5`, `@eslint/js@9.39.5`, `@eslint/eslintrc@3.3.6`, `typescript-eslint@8.65.0`, `eslint-config-prettier@10.1.8`, `globals@17.9.0` | Next 15's config accepts ESLint through 9.x, not 10.x. F-02 uses `FlatCompat` from `@eslint/eslintrc` to adapt Next 15's legacy shareable configs to ESLint 9 flat config; `3.3.6` supports Node `^18.18.0`, `^20.9.0`, or `>=21.1.0`, so the selected Node satisfies it. The compatibility package is frozen except for critical fixes, and F-04 must re-evaluate whether the shared config still needs it. `typescript-eslint` accepts TypeScript 5.9.3 and ESLint 9. ESLint 10 is deliberately excluded from this baseline. | F-02 app-local Next compatibility config; F-04 shared flat config or reviewed removal; F-07 staged lint; F-06 lint | R3 | [ESLint](https://www.npmjs.com/package/eslint/v/9.39.5), [ESLint JS](https://www.npmjs.com/package/@eslint/js/v/9.39.5), [ESLintRC](https://www.npmjs.com/package/@eslint/eslintrc/v/3.3.6), [typescript-eslint](https://www.npmjs.com/package/typescript-eslint/v/8.65.0), [config-prettier](https://www.npmjs.com/package/eslint-config-prettier/v/10.1.8), [globals](https://www.npmjs.com/package/globals/v/17.9.0) |
