...
- 下游 Enforcement：**F-01/ISSUE-003 已于 2026-08-02 在本地完成；F-02/ISSUE-004 已于 2026-08-03 在 Next.js 16 上完成并重新验证**

“已冻结”表示下游任务必须使用这些精确 Direct Selection；只有经 Review 的同一变更更新本矩阵后才能改动。D-25 仅取代原有 Next.js/MUI/TypeORM Selection；P-03 其余内容继续有效。P-03 Status 本身不声称 Installation、Lockfile、Build、Native-runtime、Database 或 CI Result 已存在；这些事实由下文指定的 Downstream Enforcement Task 证明。F-01 提供 Root Installation、Lockfile 与 Task-graph Evidence；F-02 提供已安装 Next.js Web Evidence。MUI SSR、TypeORM/PostgreSQL Runtime Behavior、Native-module Loading、Database-image Verification 与 CI 仍由后续 Owner Task 负责。
...
| MUI | `@mui/material@9.2.0`、`@mui/icons-material@9.2.0`、`@mui/material-nextjs@9.1.1` | MUI v9 是受支持的 Stable Major。Material/Icons 接受 React `^19`；独立版本的 Integration 接受 Next `^16`、React `^19` 并暴露 `v16-appRouter`。W-01 负责 Integration 前不安装任何 MUI Package。 | W-01 Manifest、`AppRouterCacheProvider`、Theme 与 SSR Proof | R2 | [Material 9.2.0](https://www.npmjs.com/package/@mui/material/v/9.2.0)、[Icons 9.2.0](https://www.npmjs.com/package/@mui/icons-material/v/9.2.0)、[Next Integration 9.1.1](https://www.npmjs.com/package/@mui/material-nextjs/v/9.1.1)、[MUI Support](https://mui.com/material-ui/getting-started/support/)、[App Router Guide](https://mui.com/material-ui/integrations/nextjs/) |
| Emotion | `@emotion/react@11.14.0`、`@emotion/styled@11.14.1`、`@emotion/cache@11.14.0` | 满足 MUI v9 与 `@mui/material-nextjs` Peer Range。App Router Path 不选择 Optional `@emotion/server`。 | W-01 Web Manifest 与 SSR Cache Provider | R2 | [Emotion React](https://www.npmjs.com/package/@emotion/react/v/11.14.0)、[Emotion Styled](https://www.npmjs.com/package/@emotion/styled/v/11.14.1)、[Emotion Cache](https://www.npmjs.com/package/@emotion/cache/v/11.14.0) |
...
| MUI 9.2.0 + `@mui/material-nextjs` 9.1.1 `v16-appRouter` Cache Provider 与 Hydration/Style Ordering | W-01 / ISSUE-008 | Server Render、Hydration、Navigation 与 Production Build Evidence |
...
因此，中英文文档通过 Repository Documentation Check 后，P-03 已于 2026-08-02 作为 Version-policy Task 关闭。D-25 于 2026-08-03 修订其 Web/ORM Row；随后 F-02 中的 Next.js 16.2.12 通过 Install、Lint、Route Type Generation、Strict TypeScript 与 Production Build。MUI 与 TypeORM Runtime Evidence 仍明确 Pending 于 W-01 与 B-01。下游失败须通过经 Review 的 Matrix Update 重新打开相应 Compatibility Decision；绝不使用 `--force`、Legacy Peer Handling、Unpinned Replacement 或 Skipped Test 隐藏失败。
