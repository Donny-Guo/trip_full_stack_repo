...
| Component | 精确选择 | Compatibility 与 Support Evidence | Pin / Downstream Enforcement | Class | Primary Source |
| --- | --- | --- | --- | --- | --- |
| ESLint | `eslint@9.39.5`、`@eslint/js@9.39.5`、`@eslint/eslintrc@3.3.6`、`typescript-eslint@8.65.0`、`eslint-config-prettier@10.1.8`、`globals@17.9.0` | Next 15 Config 最高接受 ESLint 9.x，不接受 10.x。F-02 使用 `@eslint/eslintrc` 的 `FlatCompat` 将 Next 15 Legacy Shareable Config 适配为 ESLint 9 Flat Config；`3.3.6` 支持 Node `^18.18.0`、`^20.9.0` 或 `>=21.1.0`，所选 Node 满足。该 Compatibility Package 除 Critical Fix 外已冻结；F-04 建立 Shared Config 时必须重新评估是否仍需保留。`typescript-eslint` 接受 TypeScript 5.9.3 与 ESLint 9。本基线明确排除 ESLint 10。 | F-02 App-local Next Compatibility Config；F-04 Shared Flat Config 或经 Review 后移除；F-07 Staged Lint；F-06 Lint | R3 | [ESLint](https://www.npmjs.com/package/eslint/v/9.39.5)、[ESLint JS](https://www.npmjs.com/package/@eslint/js/v/9.39.5)、[ESLintRC](https://www.npmjs.com/package/@eslint/eslintrc/v/3.3.6)、[typescript-eslint](https://www.npmjs.com/package/typescript-eslint/v/8.65.0)、[config-prettier](https://www.npmjs.com/package/eslint-config-prettier/v/10.1.8)、[globals](https://www.npmjs.com/package/globals/v/17.9.0) |
